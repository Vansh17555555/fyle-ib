...
from core.apis.teachers import principal_teachers_resources  # Import the teachers blueprint
...
app.register_blueprint(principal_teachers_resources, url_prefix='/principal/teachers')  # Register the teachers blueprint
